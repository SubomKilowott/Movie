...
class _Upcoming extends State<Upcoming> {
  ...
  Upcoming_movies? details;
  Upcoming_movies? rated;
    ...
    if (_hasNextpage == true &&
      ...
      try {
        var response = await Dio().get(
            'https://api.themoviedb.org/3/movie/upcoming?page=$_page&api_key=ff78f911e0dbd4c6c56dd3096993fb27');

        rated = Upcoming_movies.fromJson(response.data);
        if (!mounted) {
          return;
        }
  ...
  void _firstload() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        setState(() {
          details = Upcoming_movies.fromJson(response.data);
        });
      } else {
